...
page.screenshot(path='/home/user_aioc/workspace/tools/browser-temp/screenshots/cloak_test.png')
import os; sz = os.path.getsize('/home/user_aioc/workspace/tools/browser-temp/screenshots/cloak_test.png')
