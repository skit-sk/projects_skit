#!/usr/bin/env python3
"""TradingView screenshot via pure Playwright (non-stealth, stock Chromium).

Use when stealth doesn't matter — for undetectable screenshots use cloakbrowser instead.
...
with sync_playwright() as p:
    ...
    print(f"Navigating to {symbol} {tf} ...")
