...
```powershell
python ".opencode/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src"
python ".opencode/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src/Configuration.xml"
```
